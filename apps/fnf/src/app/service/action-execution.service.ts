...
import {ChangeDirDialogService} from "../feature/cmd/changedir/change-dir-dialog.service";
import {ShellLocalStorage} from "../feature/main/footer/shellpanel/shell-local-storage";
import {CleanDialogData, CmdIf, DOT_DOT, FileItemIf, FindData, FindDialogData, PanelIndex} from "@fnf-data";
import {FileTableBodyModel} from "../feature/main/filetable/file-table-body-model";
import {SelectionManagerForObjectModels} from "../feature/main/filetable/selection-manager";
import {ClipboardService} from "./clipboard-service";
import {Router} from "@angular/router";
import {RenameDialogData} from "../feature/cmd/rename/rename-dialog.data";
import {RenameDialogResultData} from "../feature/cmd/rename/rename-dialog-result.data";
import {QueueFileOperationParams} from "../feature/task/domain/queue-file-operation-params";
import {MultiRenameDialogData} from "../feature/cmd/multirename/data/multi-rename-dialog.data";
import {QueueActionEvent} from "../feature/task/domain/queue-action-event";
import {GroupFilesDialogData} from "../feature/cmd/groupfiles/data/group-files-dialog.data";
import {MultiRenameDialogService} from "../feature/cmd/multirename/multi-rename-dialog.service";
import {MultiMkdirDialogService} from "../feature/cmd/multimkdir/multi-mkdir-dialog.service";
import {GroupFilesDialogService} from "../feature/cmd/groupfiles/group-files-dialog.service";
import {RenameDialogService} from "../feature/cmd/rename/rename-dialog.service";
import {CommandService} from "../feature/task/service/command.service";
import {ChangeDirDialogData} from "../feature/cmd/changedir/data/change-dir-dialog.data";
...
import {CleanDialogService} from "../feature/cmd/clean/clean-dialog.service";
import {FindDialogService} from "../feature/cmd/find/find-dialog.service";
import {ShortcutDialogService} from "../feature/shortcut/shortcut-dialog.service";
...
import {UnzipDialogResultData} from "../feature/cmd/unzip/unzip-dialog-result.data";
...
export class ActionExecutionService {
  ...
  executeActionById(id: ActionId) {
    ...
    if (id === 'TOGGLE_PANEL') {
      ...
      this.themeConfigDialogService.open(() => {
      });
