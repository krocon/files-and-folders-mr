...
export function extComparator(value1: string, value2: string, row1?: FileItemIf, row2?: FileItemIf, f?: number): number {
  ...
  return row1.ext.toUpperCase().localeCompare(row2.ext.toUpperCase());
}
